        ...
        try {
            ...
            while(!eof) {
                ...
                if(line == null) {
                    ...
                    String codeSplit[] = lineSplit[0].split("\\*"); //break code into subject and number, clear extra whitespace
                    ...
                    if(!isDouble(lineSplit[1])) {
                        System.out.println("Error: initializeCatalog(" + filename + "): credit '" + lineSplit[1] + "' is invalid");
                        validInput = false;
                    ...
                    if(lineSplit.length == 4) {
                        String prereqSplit[] = lineSplit[3].split(":"); //break into multiple course codes, clear extra whitespace
