...
public class Planner
{
        ...
        while(!menuInput.equals("16") && !menuInput.toLowerCase().equals("quit")) {
            ...
            if(menuInput.equals("1")) {         // =================== 1 ===================
                ...
                if(pos.getScheduledCourses().isEmpty()) {
                    ...
                    removeCourseFromPlanCourseList(pos);
                }
                ...
                if(pos.getScheduledCourses().isEmpty()) {
                    ...
                    viewMissingRequiredCoursesInPlan(pos);
                }
                
            } else if(menuInput.equals("11")) { // ================== 11 ===================
                viewPrerequisitesOfRequiredCourse(pos);
                
            } else if(menuInput.equals("12")) { // ================== 12 ===================
                System.out.println("You have currently completed " + pos.getCreditsEarned() + " credits.");
                
            } else if(menuInput.equals("13")) { // ================== 13 ===================
                System.out.println("You need " + Math.max(pos.getDegreeProgram().getCreditsRequired() - pos.getCreditsEarned(), 0) +
                        " more credits to complete your plan of study.");
                
            } else if(menuInput.equals("14")) { // ================== 14 ===================
                boolean ok = pos.getDegreeProgram().meetsRequirements(pos);
                if(!ok) {
                    System.out.println("\n===================================================================\n" +
                ...
                System.out.println("You plan of study:\n===================================================================" +
                        pos.toString() + "\n===================================================================");
    ...
    public static void viewPrerequisitesOfRequiredCourse(PlanOfStudy pos) {
        ...
        while(!validInput) {
            ...
            if(!isInteger(input)) {
                System.out.println("Invalid input: please select one of the options by number [1," + pos.getScheduledCourses().size() +"]");
            } else {
                // check range of int
    ...
    public static void updateGrade(PlanOfStudy pos) {
        ...
        while(!validInput) {
            ...
            if(!isInteger(input)) {
                ...
                if(courseChoice < 1 || courseChoice > pos.getScheduledCourses().size()) {
                    System.out.println("Invalid input: please select one of the options by number [1," + pos.getScheduledCourses().size() +"]");
                } else {
                    validInput = true;
        ...
        if(!pos.getScheduledCourses().get(courseChoice-1).getCourseStatus().equals("Complete")) {
        ...
        if(isComplete) {
            ...
            while(!validInput) {
                ...
                if(!isValidGradeUserInput(input)) {
                    ...
                    validInput = true;
                    pos.getScheduledCourses().get(courseChoice-1).setCourseGrade(input);
                }
            }
        }
    }
        ...
        while(!validInput) {
            ...
            if(!isInteger(input)) {
                ...
                if(courseChoice < 1 || courseChoice > pos.getScheduledCourses().size()) {
                    ...
                    validInput = true;
                    pos.getScheduledCourses().remove(courseChoice-1);
                }
            }
        } // end while loop
    }
    ...
    public static void markCourseType(PlanOfStudy pos) {
        ...
        while(!validInput) {
            ...
            if(input.equals("Required") || input.equals("Elective") || input.equals("AreaOfApplication")) {
                validInput = true;
                pos.getScheduledCourses().get(courseChoice-1).setCourseType(input);  
            } else {
                // display error msg
    ...
    public static void markCourseStatus(PlanOfStudy pos) {
        ...
        while(!validInput) {
            ...
            if(input.equals("Complete") || input.equals("InProgress") || input.equals("Planned")) {
                validInput = true;
                pos.getScheduledCourses().get(courseChoice-1).setCourseStatus(input);  
            } else {
                // display error msg
    ...
    public static void viewMissingRequiredCoursesInPlan(PlanOfStudy pos)
    {
        ...
        for(Course c : pos.getDegreeProgram().getRequiredCourses()) {
            match = false;
            for(Course fromPlan : pos.getScheduledCourses()) {
    ...
    public static void addCourse(PlanOfStudy pos)
    {
        ...
        while(!validInput) {
            ...
            if(!isValidCourseCode(input)) {
                ...
                toAdd = new Course(pos.getDegreeProgram().getCatalog().findCourse(input));
            }
        }
        ...
        if(toAdd.getCourseStatus().equals("Complete")) {
            validInput = false;
            while(!validInput) {
                System.out.println("Enter its grade: ");
                input = sc.nextLine().trim();
                ...
                if(!isValidGradeUserInput(input)) {
                    ...
                    validInput = true;
                    toAdd.setCourseGrade(input);
                }
            }
        }
        
        // actually add it to the list
        pos.getScheduledCourses().add(toAdd);
    }
     ...
     * @param pos the Plan of Study being used
     */
    public static void loadTranscript(PlanOfStudy pos)
    {
        Scanner sc = new Scanner(System.in);
     ...
     * @param pos the Plan of Study being replaced
     */
    public static void loadPlanOfStudy(PlanOfStudy pos)
    {
        Scanner sc = new Scanner(System.in);
     ...
     * @param pos the Plan of Study being used
     */
    public static void createNewPlanOfStudy(PlanOfStudy pos)
    {
        Scanner sc = new Scanner(System.in);
        ...
        input = sc.nextLine().trim();
        pos.getUser().setFirstName(input);
        
        System.out.println("Enter your last name: ");
        input = sc.nextLine().trim();
        pos.getUser().setLastName(input);
        ...
        while(!validID) {
            ...
            if(isInteger(input)) {
                validID = true;
                pos.getUser().setStudentNumber(Integer.parseInt(input));
            } else {
    ...
    public static void printBasicPlanCourseList(PlanOfStudy pos) {
        ...
        int i = 1;
        for(Course c : pos.getScheduledCourses()) {
