 ...
 *      NOTE: assumes that input data is error checked before calling mutator methods
 */
public class Attempt implements Serializable
{
    ...
    {
        this(original.getCourseAttempted().shallowClone(), original.getAttemptStatus(), original.getSemesterTaken(),
    ...
    */
    ...
    {
        String toReturn = course.toString() + "\t" + semesterTaken + "\t\t" + 
                String.format("%-" + 10 + "." + 10 + "s", status) + "\t" + grade + "\t\t" + type;
        return toReturn;
    }
