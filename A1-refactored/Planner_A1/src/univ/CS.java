...
public class CS extends HonoursDegree implements Serializable
{
    ...
    public boolean meetsRequirements(PlanOfStudy thePlan)
    {
        ...
        for(Attempt fromPlan : thePlan.getTranscript()) {
            ...
            if(fromPlan.getAttemptStatus().equals("Complete")) {
                ...
                if(codeSplit[0].equals("CIS")) {
                    creditsCIS += fromPlan.getCourseAttempted().getCourseCredit();
                }
            }
        }
        if(creditsCIS < 11.25) {
        ...
        for(Attempt fromPlan : thePlan.getTranscript()) {
            ...
            if(fromPlan.getAttemptStatus().equals("Complete")) {
                ...
                if(codeSplit[0].equals("CIS") && codeSplit[1].charAt(0) >= '4') {
                    creditsCIS4000 += fromPlan.getCourseAttempted().getCourseCredit();
                }
            }
        }
        ...
        for(Attempt fromPlan : thePlan.getTranscript()) {
            ...
            if(fromPlan.getAttemptStatus().equals("Complete") && !codeSplit[0].equals("CIS")) {
                ...
                if(codeSplit[1].charAt(0) >= '3') {
                    subjectCount3000.put(codeSplit[0], subjectCount3000.getOrDefault(codeSplit[0], 0.0) + fromPlan.getCourseAttempted().getCourseCredit());
                }
            }
        }
        pass = false;
        ...
        if(!pass) {
            toReturn = false;
            System.out.println("You still need " + (4.0 - aoaMax) + " more credits in an area of application");
        }
        if(!pass3000) {
            toReturn = false;
